  ...
  async updateFeature(
    ...
    const updated = await prisma.feature.update({
      ...
      data: {
        ...
        ...(data.acceptanceCriteria !== undefined && { acceptanceCriteria: data.acceptanceCriteria || undefined }),
        ...(data.uiNotes !== undefined && { uiNotes: data.uiNotes || undefined }),
        ...(data.testData !== undefined && { testData: data.testData || undefined }),
        ...(data.contextImages !== undefined && { contextImages: data.contextImages?.length ? data.contextImages : undefined }),
        ...(data.endpoints !== undefined && { endpoints: data.endpoints?.length ? data.endpoints : undefined }),
      },
      include: { _count: { select: { testCases: true } } },
    })
