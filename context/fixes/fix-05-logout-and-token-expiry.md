...
typescript// In authController.ts — refresh function
...
typescript// After verifying the token and finding the user
return {
  accessToken,
...
typescript// Sidebar footer with logout
...
typescript// Each form field group should look like this:
<div className="mb-4">
...
typescript<div className="flex flex-col gap-4">
...
You should land on /projects
Refresh the page — confirm you STAY on /projects, not redirected to login
Refresh again — still on /projects ✓
Click Sign out in the sidebar
Confirm you are redirected to /login
Try navigating to /projects — confirm you are redirected back to /login
Log in again — confirm it works
Open the login page — confirm there is clear spacing between all fields
Open the register tab — confirm same spacing
